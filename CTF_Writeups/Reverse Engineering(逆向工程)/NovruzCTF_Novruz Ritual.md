...
- **附件链接**: [下载附件](https://github.com/starnotes-xj/BIGC_CTF_Writeups/raw/main/CTF_Writeups/files/Novruz%20Ritual/ad1c72b0-ca4c-4899-8e24-962d6cbc60a9.bin){target="_blank"} · [仓库位置](https://github.com/starnotes-xj/BIGC_CTF_Writeups/tree/main/CTF_Writeups/files/Novruz%20Ritual){target="_blank"}
